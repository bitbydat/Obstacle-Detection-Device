#ifndef __TIME_DRIVE_H
#define __TIME_DRIVE_H
...
void timer_pwm_micro(char port, char pin, unsigned int arr, int compare);
void timer_pwm_milli(char port, char pin, unsigned int arr, int compare);

void timer_capture_micro(char port, char pin, unsigned int arr, char edge);
void timer_capture_milli(char port, char pin, unsigned int arr, char edge);
